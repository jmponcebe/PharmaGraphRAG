...
- **Object Storage**: Google Cloud Storage (ChromaDB snapshots)
...
| API + ChromaDB | Google Cloud Run | See docs/deployment-reference.md | $0 (free tier) |
...
- **Cloud Build steps** (`cloudbuild.yaml`):
  1. Download ChromaDB snapshot from GCS bucket
...
- **GCS Bucket**: See docs/deployment-reference.md (gitignored)
