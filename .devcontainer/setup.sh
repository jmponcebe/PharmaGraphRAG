...
echo ""
echo " ⚠️  Demo data: uses a representative subset (88 drugs)."
echo "    Results may differ from the full dataset (4,998 drugs)."
echo "    For educational/portfolio purposes only."
echo ""
